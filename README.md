...
scLR-multi was initially derived from [nf-core/scnanoseq](https://github.com/nf-core/scnanoseq), which provides processing of Oxford Nanopore single-cell RNA-seq data generated using 10x Genomics. scLR-multi retains the original 10x Genomics processing workflow.
...
1. Install [Nextflow](https://www.nextflow.io/docs/latest/getstarted.html) (`>=24.10.4`, requires Java 11 or later)
...
| Platform | Sample | Input reads | ENA run accession |
| --- | --- | ---: | --- |
| 10X-3prime | 10X-3prime Rep1 | 271,541,720 | [ERR17793697](https://www.ebi.ac.uk/ena/browser/view/ERR17793697) |
| 10X-3prime | 10X-3prime Rep2 | 308,376,426 | [ERR17793698](https://www.ebi.ac.uk/ena/browser/view/ERR17793698) |
| 10X-3prime | 10X-3prime Rep3 | 298,694,391 | [ERR17793699](https://www.ebi.ac.uk/ena/browser/view/ERR17793699) |
| 10X-5prime | 10X-5prime Rep1 | 181,076,926 | [ERR17793700](https://www.ebi.ac.uk/ena/browser/view/ERR17793700) |
| 10X-5prime | 10X-5prime Rep2 | 256,241,535 | [ERR17793701](https://www.ebi.ac.uk/ena/browser/view/ERR17793701) |
| 10X-5prime | 10X-5prime Rep3 | 239,552,419 | [ERR17793702](https://www.ebi.ac.uk/ena/browser/view/ERR17793702) |
| Argentag | Argentag Rep1 | 190,023,577 | [ERR17793703](https://www.ebi.ac.uk/ena/browser/view/ERR17793703) |
| Argentag | Argentag Rep2 | 167,392,677 | [ERR17793704](https://www.ebi.ac.uk/ena/browser/view/ERR17793704) |
| Argentag | Argentag Rep3 | 137,990,113 | [ERR17793705](https://www.ebi.ac.uk/ena/browser/view/ERR17793705) |
| Parse | Parse Rep1 | 204,122,101 | [ERR17793706](https://www.ebi.ac.uk/ena/browser/view/ERR17793706) |
...
The pipeline can be tested using subsets of the full datasets deposited in ENA under study accession [PRJEB125152](https://www.ebi.ac.uk/ena/browser/view/PRJEB125152). Due to their size, test FASTQ files are not included in this repository. Instead, they can be reproducibly generated by subsampling reads from the corresponding full datasets using `seqkit`.

For 10x Genomics datasets, scLR-multi retains the barcode detection, extraction and correction workflow of nf-core/scnanoseq and remains compatible with the original nf-core/scnanoseq 10x test dataset. The test can be run by specifying the 10x platform explicitly:

```bash
nextflow run . -profile test,docker --platform 10X --outdir results
```

or, with Singularity:

```bash
nextflow run . -profile test,singularity --platform 10X --outdir results
```
